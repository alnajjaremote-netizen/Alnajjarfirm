...
function contactIcon(href: string | undefined) {
  if (!href) return (
      ...
      <div className="contact-top">
        <div className="contact-left">
          ...
          <div className="contact-list">
            {contacts.map((item, i) => (
              item.href ? (
                <a key={i} href={item.href} target="_blank" rel="noreferrer" className="contact-btn">
                  {contactIcon(item.href)}
                  {item.value}
                </a>
              ) : (
                <div key={i} className="contact-btn contact-btn--static">
                  {contactIcon(item.href)}
                  {item.value}
                </div>
              )
